...
4. **Query existing Backlog issues** — `mcp__linear__list_issues` with team "ADVA Administracion", state "Backlog". Record titles and file paths to avoid creating duplicates.
