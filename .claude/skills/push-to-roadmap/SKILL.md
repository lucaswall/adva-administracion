...
- **User context relevance** — Use project context from CLAUDE.md (Argentine invoicing, single-user admin tool, backend-only API, Google Sheets persistence, Railway deployment) to evaluate feasibility
