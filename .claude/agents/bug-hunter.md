...
- Raw exception messages, stack traces, internal file paths, or upstream API error details flowing directly into API error responses — use generic client-facing error messages and log the raw details server-side via Pino only
