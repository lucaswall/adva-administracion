...
- CRITICAL: tipoComprobante must be ONLY the letter code (A, B, C, E, NC A, NC B, NC C, NC E, ND A, ND B, ND C, ND E, LP), NOT "FACTURA" or "FACTURA A" - just the code
