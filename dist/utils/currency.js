 ...
 */
import { formatArgentineNumber as formatNumber, amountsMatch as matchAmounts } from './numbers.js';
/**
...
export function amountsMatch(a, b) {
    return matchAmounts(a, b, AMOUNT_TOLERANCE);
}
/**
 ...
 */
export function formatArgentineNumber(value) {
