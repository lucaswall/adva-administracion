 ...
 */
export function compareMatchQuality(a, b) {
...
export class FacturaPagoMatcher {
     ...
     */
    constructor(dateRangeBefore = 10, dateRangeAfter = 60, crossCurrencyTolerancePercent = DEFAULT_CROSS_CURRENCY_TOLERANCE) {
    ...
    findMatches(pago, facturas) {
        ...
        for (const factura of facturas) {
            ...
            const crossCurrencyResult = amountsMatchCrossCurrency(factura.importeTotal, factura.moneda, factura.fechaEmision, pago.importePagado, this.crossCurrencyTolerancePercent);
            ...
            const existingMatchConfidence = isUpgrade ? (factura.matchConfidence || 'LOW') : undefined;
     ...
     */
    calculateConfidence(isWithinMediumRange, cuitMatch, nameMatch, isCrossCurrency = false) {
...
export class ReciboPagoMatcher {
     ...
     */
    constructor(dateRangeBefore = 10, dateRangeAfter = 60) {
        // Use provided values for LOW tier, keep HIGH and MEDIUM defaults
        this.dateRanges = {
            high: { ...DEFAULT_DATE_RANGES.high },
            medium: { ...DEFAULT_DATE_RANGES.medium },
    ...
    findMatches(pago, recibos) {
        ...
        for (const recibo of recibos) {
            ...
            const existingMatchConfidence = isUpgrade ? (recibo.matchConfidence || 'LOW') : undefined;
     ...
     * @returns Confidence level
     */
    calculateConfidence(isWithinMediumRange, cuilMatch, nameMatch) {
